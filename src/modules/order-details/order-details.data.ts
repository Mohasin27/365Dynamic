...
import { AsyncResult, ChannelDeliveryOptionConfiguration, ChannelIdentity, FeatureState, LoyaltyCard, OrgUnitLocation, ProductDeliveryOptions, SalesOrder, SimpleProduct, TenderType } from '@msdyn365-commerce/retail-proxy';
