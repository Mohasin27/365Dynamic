        ...
        <>
            {
                props.isSelectionModeEnabled ? (
                    <th>
                        <OrderDetailsHeaderCheckboxComponent
                            {...props}
                        />
                    </th>
                ) : undefined
            ...
            <th className={columnWithNumberClassName}>
            ...
            </th>
            {
                props.isCashAndCarryTransaction ? undefined : (
                    <th>
                        {resources.orderDetailsStatusText}
                    </th>
                )
            }
            <th className={columnWithNumberClassName}>
            ...
            <th>
                {resources.orderDetailsUnitOfMeasureText}
            </th>
            <th className={columnWithNumberClassName}>
...
const OrderDetailsMobileHeaderCellsComponent: React.FC<IOrderDetailsTableHeaderProps> = (props: IOrderDetailsTableHeaderProps) => {
    ...
    return (
        <>
            ...
            <th />
            <th className={`${props.className}__row`}>
                {resources.orderDetailsProductText}
            </th>
        </>
    );
