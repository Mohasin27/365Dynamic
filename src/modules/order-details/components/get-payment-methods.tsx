...
export const getOrderDetailsPaymentMethods = ({
    ...
    const getCard = (tenderLine: TenderLine, showAmount: boolean = false) => {
        ...
        return (
            <div className='ms-order-details__payment-methods-line' key={tenderLine.TenderTypeId}>
                ...
                {showAmountCovered && <p className='ms-order-details__payment-methods-card-amount-info'>
                    {amountCoveredLabel}
                    <PriceComponent
                        {...priceContext}
    ...
    const getCash = (tenderLine: TenderLine) => (
        <div className='ms-order-details__payment-methods-line' key={tenderLine.TenderTypeId}>
            <p className='ms-order-details__payment-methods-cash'>
                {cashUsedLabel}
            </p>
    ...
    return {
        ...
        title: <div className='ms-order-details__payment-methods-title'>
            {paymentMethodsTitle}
        </div>,
