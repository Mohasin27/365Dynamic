...
import { getBuyboxFindInStore, IBuyboxFindInStoreViewProps, getDealOfTheDayDiv, IDealOfTheDayDivProps } from './components/buybox-find-in-store';
import { getExcelImportControl, IBuyboxExcelImportViewProps } from './components/buybox-excel-import';
...
export interface IBuyboxViewProps extends IBuyboxProps<IBuyboxData> {
    ...
    dealOfTheDay?: IDealOfTheDayDivProps;  
    excelImport?: IBuyboxExcelImportViewProps;  
}
...
class Buybox extends React.PureComponent<IBuyboxProps<IBuyboxData>, IBuyboxState> {
    ...
    public render(): JSX.Element | null {
        ...
        const viewProps: IBuyboxViewProps = {
            ...
            max,
            dealOfTheDay: getDealOfTheDayDiv(this.props),
            excelImport: getExcelImportControl(this.props)
        };
