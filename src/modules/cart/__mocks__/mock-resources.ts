...
export const mockResources = {
    ...
    invoiceSummaryTitle: 'Payment summary',
    invoiceLabel: 'Invoice {0}',
    ...
    createOrderTemplateFromCartButton: 'Save all items to order template',
    createOrderTemplateFromCartButtonTooltip: 'Products on this shopping bag cannot be added to order template due to custom pricing',
    ...
    linesAddedToOrderTemplateCustomPriceAlertMessageText: 'linesAddedToOrderTemplateCustomPriceAlertMessageText',
    ...
    promotionStringHeading: 'We found offers available based on the items on the cart',
    promotionLinkText: 'See all',
    promotionCloseButtonAriaLabel: 'Close',
    promotionPopupHeading: 'Close',
    pickUpText: 'Pickup',
