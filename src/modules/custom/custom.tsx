...
import { ICustomConfig, ICustomProps } from './custom.props.autogenerated';
 ...
 */
export interface ICookieComplianceViewProps extends ICustomProps<{}> {
 ...
 * @extends {React.PureComponent<ICustomProps<IHeroConfig>>}
 */
class CookieCompliance extends React.PureComponent<ICustomProps<ICustomConfig>, IAlertState> {
    ...
    public constructor(props: ICustomProps<ICustomConfig>) {
        super(props);
    ...
    public render(): JSX.Element | null {
        ...
        let moduleConfig: ICustomConfig;
