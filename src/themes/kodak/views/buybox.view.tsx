    ...
    return (
        <Module {...ModuleProps}>
            ...
            <Node {...ProductInfoContainerProps}>
                ...
                { findInStore &&  _renderShippingStatus(findInStore, props.context.actionContext)}
...
const _renderShippingStatus = (findInStore: IBuyboxFindInStoreViewProps, actionContext: IActionContext): JSX.Element => {
