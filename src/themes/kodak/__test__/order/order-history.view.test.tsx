...
import {
    IHeader, IOrderDetailsData, IOrderDetailsProps, IOrderHistoryViewProps
...
describe('OrderHistory', () => {
    ...
    it('renders OrderHistory correctly', () => {
        const modulePropsWithSalesOrderWithAmount: IOrderDetailsProps<IOrderDetailsData> = {
            ...(Msdyn365.buildMockModuleProps({}, {}, {}, mockContext) as IOrderDetailsProps<
                IOrderDetailsData
            >),
        ...
        const viewProps: IOrderHistoryViewProps = {
            orderHistoryProps: { className: 'class',
                moduleProps: modulePropsWithSalesOrderWithAmount
            },
            orderHistory: {
