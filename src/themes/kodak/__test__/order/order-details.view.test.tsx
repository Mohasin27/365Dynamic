...
import {
    AsyncResult, ChannelDeliveryOptionConfiguration, ChannelIdentity, FeatureState, LoyaltyCard,
    OrgUnitLocation, SalesOrder, SimpleProduct
} from '@msdyn365-commerce/retail-proxy';
import {
    IOrderDetailsData, IOrderDetailsProps, OrderDetails
...
import {
    mockConfigResources,
    mockProducts, mockSalesOrderWithAmount,
    mockTenderTypes } from './__mock';
...
describe('OrderDetails', () => {
    ...
    it('renders sales order with amount', () => {
        const modulePropsWithSalesOrderWithAmount: IOrderDetailsProps<IOrderDetailsData> = {
            ...(Msdyn365.buildMockModuleProps(mockDataWithSalesOrderWithAmount, {}, mockConfigSalesOrder, mockContext) as IOrderDetailsProps<
                IOrderDetailsData
            >),
