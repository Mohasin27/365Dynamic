...
import { ICartlinesViewProps,
    ICartViewProps } from '@msdyn365-commerce-modules/cart';
...
describe('Cart view unit tests - View', () => {
    it('renders correctly _renderGroupBOPISBlock', () => {
        ...
        component.find('.msc-cart-line__remove-item').at(3).simulate('click');
    ...
    it('renders correctly with promotions', () => {
        ...
        const mockProps = {
            ...
            promotionOptions: {
                ...
                promotionSeeAllLink: (<a href='http://www.xyz.com' className='msc-cart__promotion_link'>
                    {' '}
                    {mockTextDiv}
                    {' '}
                </a>),
